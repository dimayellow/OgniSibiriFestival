...
public class SpringConfig {
    ...
    @Bean
    public OgniSibiriBot ogniSibiriBot(SetWebhook setWebhook, MessageHandler messageHandler, CallbackQueryHandler callbackQueryHandler) {
        OgniSibiriBot ogniSibiriBot = new OgniSibiriBot(setWebhook, messageHandler, callbackQueryHandler);
